...
public class Transaction {
    ...
    public boolean make() {
        ...
        if (!ItemShop.containsAtLeast(buyer.getInventory(), price, price.getAmount())) {
            //No money
        ...
        if (owner != null) {
            CoreProtectLogger.logShopBuy(buyer, owner, shop.getLocation(), price, products.get(0));
        } else {
            CoreProtectLogger.logShopBuy(buyer, buyer, shop.getLocation(), price, products.get(0));
        }
