...
public abstract class Connector {
    ...
    public Connector(Message message, Location origin, Player player) throws IllegalArgumentException {
        ...
        sendTitle(player);
        NormalShops.getInstance().getConnectorManager().registerConnector(this);
    }
    ...
    void connect(Location target) {
        ...
        NormalShops.getInstance().getConnectorManager().unregisterConnector(this);
    }
    ...
    void cancel(boolean unregister) {
        ...
        if (unregister) NormalShops.getInstance().getConnectorManager().unregisterConnector(this);
    }
